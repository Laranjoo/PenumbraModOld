...
namespace PenumbraMod.Content.Items
{
	public class EnchantedShot : ModProjectile
	{
		...
		{
            int dust = Dust.NewDust(Projectile.Center, 1, 4, DustID.Enchanted_Gold, 0f, 0f, 0, Color.LightBlue, 1f);
            ...
            int dust2 = Dust.NewDust(Projectile.Center, 1, 1, DustID.Enchanted_Pink, 0f, 0f, 0);
