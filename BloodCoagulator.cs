...
namespace PenumbraMod.Content.Items
{
	public class BloodCoagulator : ModItem
	{
		...
		public override void SetDefaults()
		{
			...
			Item.autoReuse = true;
			Item.shoot = ModContent.ProjectileType<Content.Items.BloodShot>();
			Item.shootSpeed = 18f;
			Item.noMelee = true;
        ...
        public override void AddRecipes()
		{
			...
			recipe.AddIngredient(ModContent.ItemType<PenumbraMod.Content.Items.Placeable.BloodystoneBar>(), 7);
            ...
            recipealternative.AddIngredient(ModContent.ItemType<PenumbraMod.Content.Items.Placeable.BloodystoneBar>(), 7);
