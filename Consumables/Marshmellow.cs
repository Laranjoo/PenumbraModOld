...
namespace PenumbraMod.Content.Items.Consumables
{
	public class Marshmellow : ModItem
	{
		...
		public override void SetDefaults() {
			...
			Item.scale = 2.0f;
			Item.healLife = 5; // While we change the actual healing value in GetHealLife, Item.healLife still needs to be higher than 0 for the item to be considered a healing item
		...
		public override void ModifyTooltips(List<TooltipLine> tooltips) {
			...
			if (line != null) {
				...
				line.Text = Language.GetTextValue("Restores 5 life"
					+ "\nYummy!");
			}
		}
